...
% Last Modified by GUIDE v2.5 11-Oct-2018 16:47:14
...
% --- Executes on button press in btnadventure.
function btnadventure_Callback(hObject, eventdata, handles)
close(home);
AdventureQuestion; 
% hObject    handle to btnadventure (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in btnNature.
function btnNature_Callback(hObject, eventdata, handles)
close(home);
NatureQuestion; 
% hObject    handle to btnNature (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in btnhistory.
function btnhistory_Callback(hObject, eventdata, handles)
close(home);
HistoryQuestions; 
% hObject    handle to btnhistory (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
